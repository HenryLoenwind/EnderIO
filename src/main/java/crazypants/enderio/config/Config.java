...
public final class Config {
  ...
  public static int diamondEdgedShearsDurabilityFactor = 12;
  public static float diamondEdgedShearsEffeciencyFactor = 3.5f;
  public static int diamondEdgedShearsBlockArea = 1;
  public static float diamondEdgedShearsEntityArea = 1.5f;
  ...
  public static void processConfig(Configuration config) {
    ...
    diamondEdgedShearsDurabilityFactor = config.get(sectionDarkSteel.name, "diamondEdgedShearsDurabilityFactor", diamondEdgedShearsDurabilityFactor,
        "How much more durable as vanilla shears they are.").getInt(diamondEdgedShearsDurabilityFactor);
    diamondEdgedShearsEffeciencyFactor = (float) config.get(sectionDarkSteel.name, "diamondEdgedShearsEffeciencyFactor",
        diamondEdgedShearsEffeciencyFactor, "How much more effecient as vanilla shears they are.").getDouble(diamondEdgedShearsEffeciencyFactor);
    diamondEdgedShearsBlockArea = config.get(sectionDarkSteel.name, "diamondEdgedShearsBlockArea", diamondEdgedShearsBlockArea,
        "The effected area (radius) when used on blocks.").getInt(diamondEdgedShearsBlockArea);
    diamondEdgedShearsEntityArea = (float) config.get(sectionDarkSteel.name, "diamondEdgedShearsEntityArea",
        diamondEdgedShearsEntityArea, "The effected area (radius) when used on sheep.").getDouble(diamondEdgedShearsEntityArea);
